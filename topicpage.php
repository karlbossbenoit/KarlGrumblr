...
<body class="w3-pale-blue">
  ...
  <div class="w3-bar w3-red w3-card-2 w3-left-align w3-large">
    ...
    <a href="topicpage2.php" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-white">Topics</a>
	...
	<header class="w3-container w3-red w3-center" style="padding:64px 4px">
		<h1 class="w3-yellow" >Choose The Categories you Feel the Most Comfortable with</h1>
  		<h1 class="w3-margin w3-jumbo">Add Topic</h1>
...
<div class="w3-pale-blue">
	...
	<form action="topicpage.php" method="POST" autocomplete="off">	
  		...
  		<input type="checkbox" name="school" value="school" > Add school<br>
  		<input type="checkbox" name="dailylife" value="dailylife"> Add daily life<br>
  		<input type="checkbox" name="entertainment" value="entertainment" > Add entertainment<br>

...
<script
  ...
  <script>
    ...
    //     $("#dvMain").load("loginlog.php");
    // },300);
   
   $("#dvMain").load("loginlog.php");
   var count = "<?php session_start(); echo $_SESSION['count'];  ?>";
   var note = "<?php session_start(); echo $_SESSION['themsg'];?>";
   //$("#dvMain").append(logs);
   //
   ...
   for(){
    ...
    //// $("#user2").append("<li class='other'><div class='avatar'><img src='https://i.imgur.com/DY6gND0.png' draggable='false'/></div><div class='msg' id='chatboxing'><time>20:17</time></div></li>");
...
<div class="menu">
            ...
            <div class="name"><?php session_start(); echo $_SESSION['login'];?></div>
            <div class="last">18:09</div>
        </div>


    <ol class="chat" id="dvMain">
        <!-- <div id='input'>
    ...
    <ol class="chat" id="user2">
        <li class="self">
        <div class="avatar"><img src="https://i.imgur.com/HYcn9xO.png" draggable="false"/></div>
      <div class="msg" id="chatboxy"></div>
    ...
    <form action="template2.php" method="POST" autocomplete="off">
    <input class="textarea" type="text" placeholder="Type here!" id="msg" /><div class="emojis"></div>

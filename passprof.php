...
<div class="w3-row-padding w3-padding-64 w3-container">
  ...
  <ul class="dropdown-menu">
    <form action="passprof.php" method="POST" autocomplete="off">
    <li><i class="fa fa-pencil fa-fw"></i>username: <?php echo $_SESSION['login'];?></li>
    
    <li><i class="fa fa-pencil fa-fw"></i>password: <?php echo $_SESSION['pass'];?></li>
    <input type="text" name="pass">
     <button type='submit' name='changepass'>Change Pass</button>
    </form>
  </ul>
</div>
